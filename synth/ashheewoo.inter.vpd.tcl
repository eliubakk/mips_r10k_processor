...
# DVE full session
# Saved on Wed Apr 17 23:03:07 2019
# Designs open: 1
#   Sim: dve
...
#   Group Group15 signal count = 18
#   Group CDB_0 signal count = 9
...
#<Session mode="Full" path="/afs/umich.edu/user/h/e/heewoo/Desktop/eecs470/FINAL/group10w19/synth/ashheewoo.inter.vpd.tcl" type="Debug">
...
set _session_group_41 Group13
gui_sg_create "$_session_group_41"
set Group13 "$_session_group_41"
...
set _session_group_42 Group14
gui_sg_create "$_session_group_42"
set Group14 "$_session_group_42"
...
gui_view_scroll -id ${Hier.1} -vertical -set 287
...
catch { gui_list_select -id ${Data.1} {testbench.pipeline_0.load_queue.load_out testbench.pipeline_0.load_queue.mem_tag_hits testbench.pipeline_0.load_queue.clock testbench.pipeline_0.load_queue.read_valid testbench.pipeline_0.load_queue.head testbench.pipeline_0.load_queue.reset testbench.pipeline_0.load_queue.load_in testbench.pipeline_0.load_queue.tag_found testbench.pipeline_0.load_queue.load_queue testbench.pipeline_0.load_queue.mem_tag testbench.pipeline_0.load_queue.write_en testbench.pipeline_0.load_queue.head_next testbench.pipeline_0.load_queue.tail testbench.pipeline_0.load_queue.full testbench.pipeline_0.load_queue.pop_en testbench.pipeline_0.load_queue.tail_next testbench.pipeline_0.load_queue.load_queue_next {testbench.pipeline_0.load_queue.$unit} }}
...
gui_open_source -id ${Source.1}  -replace -active _vcs_unit__76041625 /afs/umich.edu/user/h/e/heewoo/Desktop/eecs470/FINAL/group10w19/verilog/pipeline.v
...
gui_wv_zoom_timerange -id ${Wave.1} 4419 7587
...
gui_list_add_group -id ${Wave.1} -after {New Group} {CDB_0}
...
gui_list_expand -id ${Wave.1} testbench.pipeline_0.ex_co_dest_reg_idx
gui_list_expand -id ${Wave.1} testbench.pipeline_0.ex_co_valid_inst
gui_list_expand -id ${Wave.1} testbench.pipeline_0.load_queue.load_out
gui_list_select -id ${Wave.1} {testbench.pipeline_0.load_queue.load_out.IR }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group Group7  -item testbench.pipeline_0.mem_co_comb -position below

gui_marker_move -id ${Wave.1} {C1} 6002
gui_view_scroll -id ${Wave.1} -vertical -set 1103
