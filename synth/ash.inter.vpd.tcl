...
# DVE full session
# Saved on Mon Apr 15 14:46:31 2019
# Designs open: 1
#   Sim: dve
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 258} {height 713} {dock_state left} {dock_on_new_line true} {child_hier_colhier 149} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 495} {height 713} {dock_state left} {dock_on_new_line true} {child_data_colvariable 212} {child_data_colvalue 153} {child_data_coltype 144} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{1 140} {1920 1120}}
...
catch {gui_list_select -id ${Hier.1} {testbench.pipeline_0.inst_memory}}
gui_view_scroll -id ${Hier.1} -vertical -set 167
gui_view_scroll -id ${Hier.1} -horizontal -set 0

# Data 'Data.1'
gui_list_set_filter -id ${Data.1} -list { {Buffer 1} {Input 1} {Others 1} {Linkage 1} {Output 1} {LowPower 1} {Parameter 1} {All 1} {Aggregate 1} {LibBaseMember 1} {Event 1} {Assertion 1} {Constant 1} {Interface 1} {BaseMembers 1} {Signal 1} {$unit 1} {Inout 1} {Variable 1} }
gui_list_set_filter -id ${Data.1} -text {*}
gui_list_show_data -id ${Data.1} {testbench.pipeline_0.inst_memory}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {testbench.pipeline_0.inst_memory.current_tag testbench.pipeline_0.inst_memory.PC_in_Plus testbench.pipeline_0.inst_memory.cam_table_in testbench.pipeline_0.inst_memory.cache_rd_idx testbench.pipeline_0.inst_memory.cache_wr_idx testbench.pipeline_0.inst_memory.last_PC_in testbench.pipeline_0.inst_memory.PC_in_hits testbench.pipeline_0.inst_memory.PC_cam_hits testbench.pipeline_0.inst_memory.unanswered_miss testbench.pipeline_0.inst_memory.Imem2proc_data testbench.pipeline_0.inst_memory.Imem2proc_response testbench.pipeline_0.inst_memory.PC_queue testbench.pipeline_0.inst_memory.NUM_WAYS testbench.pipeline_0.inst_memory.clock testbench.pipeline_0.inst_memory.reset testbench.pipeline_0.inst_memory.cache_rd_tag testbench.pipeline_0.inst_memory.cache_wr_tag testbench.pipeline_0.inst_memory.update_mem_tag testbench.pipeline_0.inst_memory.cache_miss_PC_in_valid_rd testbench.pipeline_0.inst_memory.cache_wr_en testbench.pipeline_0.inst_memory.current_index testbench.pipeline_0.inst_memory.cache_rd_miss_idx testbench.pipeline_0.inst_memory.changed_addr testbench.pipeline_0.inst_memory.send_req_ptr testbench.pipeline_0.inst_memory.cache_rd_data testbench.pipeline_0.inst_memory.PC_in_Plus_hits testbench.pipeline_0.inst_memory.mem_waiting_ptr testbench.pipeline_0.inst_memory.cache_rd_valid testbench.pipeline_0.inst_memory.mem_waiting_ptr_next testbench.pipeline_0.inst_memory.PC_queue_tail testbench.pipeline_0.inst_memory.cache_wr_miss_idx testbench.pipeline_0.inst_memory.send_req_ptr_next testbench.pipeline_0.inst_memory.cache_rd_miss_tag testbench.pipeline_0.inst_memory.proc2Imem_addr testbench.pipeline_0.inst_memory.proc2Imem_command testbench.pipeline_0.inst_memory.cache_wr_miss_tag testbench.pipeline_0.inst_memory.cache_wr_data testbench.pipeline_0.inst_memory.PC_queue_next testbench.pipeline_0.inst_memory.Imem2proc_tag testbench.pipeline_0.inst_memory.Icache_valid_out testbench.pipeline_0.inst_memory.cam_tags_in testbench.pipeline_0.inst_memory.PC_in testbench.pipeline_0.inst_memory.RD_PORTS testbench.pipeline_0.inst_memory.send_request testbench.pipeline_0.inst_memory.cache_rd_en testbench.pipeline_0.inst_memory.mem_done {testbench.pipeline_0.inst_memory.$unit} testbench.pipeline_0.inst_memory.NUM_SETS testbench.pipeline_0.inst_memory.proc2Icache_addr testbench.pipeline_0.inst_memory.PC_queue_tail_next testbench.pipeline_0.inst_memory.cache_rd_miss_valid testbench.pipeline_0.inst_memory.cache_wr_miss_valid testbench.pipeline_0.inst_memory.Icache_data_out }}
...
gui_open_source -id ${Source.1}  -replace -active _vcs_unit__3321579943 /afs/umich.edu/user/a/s/ashvarma/470/final/group10w19/verilog/pipeline.v
...
gui_wv_zoom_timerange -id ${Wave.1} 22645 23431
...
gui_list_expand -id ${Wave.1} testbench.pipeline_0.inst_memory.cache_rd_en
gui_list_expand -id ${Wave.1} testbench.pipeline_0.inst_memory.cache_rd_idx
gui_list_expand -id ${Wave.1} testbench.pipeline_0.inst_memory.cache_rd_tag
gui_list_expand -id ${Wave.1} testbench.pipeline_0.inst_memory.cache_rd_valid
gui_list_expand -id ${Wave.1} testbench.pipeline_0.inst_memory.PC_queue
gui_list_expand -id ${Wave.1} {testbench.pipeline_0.inst_memory.PC_queue[5]}
gui_list_expand -id ${Wave.1} {testbench.pipeline_0.inst_memory.PC_queue[4]}
gui_list_expand -id ${Wave.1} {testbench.pipeline_0.inst_memory.PC_queue[3]}
gui_list_expand -id ${Wave.1} {testbench.pipeline_0.inst_memory.PC_queue[2]}
gui_list_expand -id ${Wave.1} {testbench.pipeline_0.inst_memory.PC_queue[1]}
gui_list_expand -id ${Wave.1} {testbench.pipeline_0.inst_memory.PC_queue[0]}
gui_list_expand -id ${Wave.1} testbench.pipeline_0.inst_memory.PC_queue_tail
gui_list_select -id ${Wave.1} {{testbench.pipeline_0.inst_memory.PC_queue_tail[2]} }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group Group12  -position in

gui_marker_move -id ${Wave.1} {C1} 19110
gui_view_scroll -id ${Wave.1} -vertical -set 3303
