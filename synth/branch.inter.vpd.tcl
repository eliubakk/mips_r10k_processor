...
# DVE full session
# Saved on Fri Apr 5 13:46:01 2019
# Designs open: 1
#   Sim: dve
...
#   Wave.2: 5 signals
#   Group count = 2
#   Group if_stage_0 signal count = 20
...
#<Session mode="Full" path="/afs/umich.edu/user/s/u/surajrs/470/group10w19/synth/pipeline/branch.inter.vpd.tcl" type="Debug">
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 3439} {height 274} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${HSPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_hier_colhier 1775} {child_hier_coltype 1660} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_data_colvariable 1216} {child_data_colvalue 1063} {child_data_coltype 1157} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_show_window -window ${TopLevel.3} -show_state maximized -rect {{60 66} {3499 1406}}
...
gui_update_layout -id ${Wave.2} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 999} {child_wave_right 2435} {child_wave_colname 497} {child_wave_colvalue 498} {child_wave_col1 0} {child_wave_col2 1}}
...
set _session_group_5 if_stage_0
gui_sg_create "$_session_group_5"
set if_stage_0 "$_session_group_5"

gui_sg_addsignal -group "$_session_group_5" { testbench.pipeline_0.if_stage_0.Imem_valid testbench.pipeline_0.if_stage_0.next_ready_for_valid testbench.pipeline_0.if_stage_0.if_IR_out testbench.pipeline_0.if_stage_0.clock testbench.pipeline_0.if_stage_0.reset testbench.pipeline_0.if_stage_0.next_PC testbench.pipeline_0.if_stage_0.PC_reg testbench.pipeline_0.if_stage_0.PC_plus_4 testbench.pipeline_0.if_stage_0.co_ret_take_branch testbench.pipeline_0.if_stage_0.co_ret_valid_inst testbench.pipeline_0.if_stage_0.if_valid_inst_out testbench.pipeline_0.if_stage_0.if_NPC_out testbench.pipeline_0.if_stage_0.co_ret_branch_valid testbench.pipeline_0.if_stage_0.Imem2proc_data testbench.pipeline_0.if_stage_0.proc2Imem_addr {testbench.pipeline_0.if_stage_0.$unit} testbench.pipeline_0.if_stage_0.ready_for_valid testbench.pipeline_0.if_stage_0.PC_enable testbench.pipeline_0.if_stage_0.dispatch_en testbench.pipeline_0.if_stage_0.co_ret_target_pc }

set _session_group_6 Group1
gui_sg_create "$_session_group_6"
set Group1 "$_session_group_6"

gui_sg_addsignal -group "$_session_group_6" { testbench.pipeline_0.dispatch_no_hazard testbench.pipeline_0.id_di_valid_inst testbench.pipeline_0.rs_free_rows_next_out testbench.pipeline_0.fr_empty testbench.pipeline_0.rob_free_rows_next_out }
...
gui_list_set_filter -id ${Data.1} -text {rob_free_rows_next_out}
gui_list_show_data -id ${Data.1} {testbench.pipeline_0}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {testbench.pipeline_0.rob_free_rows_next_out }}
...
gui_wv_zoom_timerange -id ${Wave.1} 1203 7462
gui_list_add_group -id ${Wave.1} -after {New Group} {if_stage_0}
gui_list_select -id ${Wave.1} {testbench.pipeline_0.if_stage_0.next_PC }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group if_stage_0  -position in

gui_marker_move -id ${Wave.1} {C1} 4343
...
gui_wv_zoom_timerange -id ${Wave.2} 516 6399
gui_list_add_group -id ${Wave.2} -after {New Group} {Group1}
gui_list_select -id ${Wave.2} {testbench.pipeline_0.fr_empty }
...
gui_marker_move -id ${Wave.2} {C1} 4343
