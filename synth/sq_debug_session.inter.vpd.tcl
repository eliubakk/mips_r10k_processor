...
# DVE full session
# Saved on Sun Apr 14 01:17:35 2019
# Designs open: 1
#   Sim: dve
...
#<Session mode="Full" path="/afs/umich.edu/user/a/s/ashvarma/470/final/group10w19/synth/sq_debug_session.inter.vpd.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{1 218} {2283 1405}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 181} {height 939} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 487} {height 939} {dock_state left} {dock_on_new_line true} {child_data_colvariable 212} {child_data_colvalue 153} {child_data_coltype 144} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 2282} {height 173} {dock_state bottom} {dock_on_new_line true}}
...
gui_wv_zoom_timerange -id ${Wave.1} 4004 4601
gui_list_add_group -id ${Wave.1} -after {New Group} {Group1}
gui_list_expand -id ${Wave.1} testbench.pipeline_0.store_queue.addr
gui_list_expand -id ${Wave.1} testbench.pipeline_0.store_queue.addr_ready
gui_list_select -id ${Wave.1} {testbench.pipeline_0.store_queue.rd_valid }
...
gui_marker_move -id ${Wave.1} {C1} 4118
