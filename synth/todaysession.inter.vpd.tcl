...
# DVE full session
# Saved on Thu Apr 18 02:38:19 2019
# Designs open: 1
#   Sim: dve
...
#<Session mode="Full" path="/afs/umich.edu/user/s/u/surajrs/470/group10w19/synth/todaysession.inter.vpd.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{0 65} {2288 1284}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 246} {height 988} {dock_state left} {dock_on_new_line true} {child_hier_colhier 149} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 483} {height 988} {dock_state left} {dock_on_new_line true} {child_data_colvariable 212} {child_data_colvalue 153} {child_data_coltype 144} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 2288} {height 156} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{1 140} {2560 1480}}
...
gui_show_window -window ${TopLevel.3} -show_state maximized -rect {{21 140} {2580 1480}}
...
gui_show_window -window ${TopLevel.4} -show_state minimized -rect {{1 66} {2560 1406}}
...
gui_update_layout -id ${Wave.3} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 743} {child_wave_right 1811} {child_wave_colname 369} {child_wave_colvalue 370} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_sg_addsignal -group "$_session_group_9" { testbench.clock_count testbench.pipeline_0.rob_retire_out }
...
gui_list_set_filter -id ${Data.1} -text {rob_retire_out}
gui_list_show_data -id ${Data.1} {testbench.pipeline_0}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {testbench.pipeline_0.rob_retire_out }}
...
gui_wv_zoom_timerange -id ${Wave.1} 0 8410
gui_list_add_group -id ${Wave.1} -after {New Group} {mem_stage_0}
gui_list_select -id ${Wave.1} {testbench.pipeline_0.mem_stage_0.ex_mem_wr_mem }
...
gui_marker_move -id ${Wave.1} {C1} 2465
...
gui_wv_zoom_timerange -id ${Wave.2} 0 8410
gui_list_add_group -id ${Wave.2} -after {New Group} {memory}
gui_list_select -id ${Wave.2} {testbench.memory.valid_address }
...
gui_list_set_insertion_bar  -id ${Wave.2} -group memory  -item {testbench.pipeline_0.proc2Imem_command[1:0]} -position below

gui_marker_move -id ${Wave.2} {C1} 2465
...
gui_wv_zoom_timerange -id ${Wave.3} 2720 5796
gui_list_add_group -id ${Wave.3} -after {New Group} {Group4}
gui_list_expand -id ${Wave.3} testbench.pipeline_0.rob_retire_out
gui_list_select -id ${Wave.3} {testbench.pipeline_0.rob_retire_out.opcode }
...
gui_list_set_insertion_bar  -id ${Wave.3} -group Group4  -position in

gui_marker_move -id ${Wave.3} {C1} 2465
