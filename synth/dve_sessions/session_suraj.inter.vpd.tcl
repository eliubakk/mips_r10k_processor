...
# DVE full session
# Saved on Fri Apr 12 01:48:55 2019
# Designs open: 1
#   Sim: dve
...
#<Session mode="Full" path="/afs/umich.edu/user/s/u/surajrs/470/group10w19/synth/pipeline/session_suraj.inter.vpd.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{1 242} {2259 1405}}
...
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 2259
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 221
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 2258} {height 220} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${HSPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_hier_colhier 1336} {child_hier_coltype 1220} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_data_colvariable 833} {child_data_colvalue 680} {child_data_coltype 772} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_show_window -window ${TopLevel.2} -show_state minimized -rect {{60 74} {2619 1414}}
...
gui_show_window -window ${TopLevel.3} -show_state maximized -rect {{60 74} {2619 1414}}
...
gui_sg_addsignal -group "$_session_group_33" { testbench.pipeline_0.rob_retire_out }

set _session_group_34 $_session_group_33|
append _session_group_34 memory
gui_sg_create "$_session_group_34"
set Group1|memory "$_session_group_34"

gui_sg_addsignal -group "$_session_group_34" { testbench.memory.cycles_left testbench.memory.mem2proc_response testbench.memory.next_mem2proc_tag testbench.memory.waiting_for_bus testbench.memory.valid_address testbench.memory.bus_filled testbench.memory.loaded_data testbench.memory.acquire_tag testbench.memory.next_mem2proc_data testbench.memory.next_mem2proc_response testbench.memory.clk testbench.memory.mem2proc_tag testbench.memory.mem2proc_data {testbench.memory.$unit} testbench.memory.proc2mem_data testbench.memory.proc2mem_command testbench.memory.proc2mem_addr }

gui_sg_move "$_session_group_34" -after "$_session_group_33" -pos 1 

set _session_group_35 $_session_group_33|
append _session_group_35 memory_1
gui_sg_create "$_session_group_35"
set Group1|memory_1 "$_session_group_35"

gui_sg_addsignal -group "$_session_group_35" { testbench.memory.cycles_left testbench.memory.mem2proc_response testbench.memory.next_mem2proc_tag testbench.memory.waiting_for_bus testbench.memory.valid_address testbench.memory.bus_filled testbench.memory.loaded_data testbench.memory.acquire_tag testbench.memory.next_mem2proc_data testbench.memory.next_mem2proc_response testbench.memory.clk testbench.memory.mem2proc_tag testbench.memory.mem2proc_data {testbench.memory.$unit} testbench.memory.proc2mem_data testbench.memory.proc2mem_command testbench.memory.proc2mem_addr }

set _session_group_36 memory
gui_sg_create "$_session_group_36"
set memory "$_session_group_36"

gui_sg_addsignal -group "$_session_group_36" { testbench.memory.cycles_left testbench.memory.mem2proc_response testbench.memory.next_mem2proc_tag testbench.memory.waiting_for_bus testbench.memory.valid_address testbench.memory.bus_filled testbench.memory.loaded_data testbench.memory.acquire_tag testbench.memory.next_mem2proc_data testbench.memory.next_mem2proc_response testbench.memory.clk testbench.memory.mem2proc_tag testbench.memory.mem2proc_data {testbench.memory.$unit} testbench.memory.proc2mem_data testbench.memory.proc2mem_command testbench.memory.proc2mem_addr testbench.pipeline_0.clock testbench.pipeline_0.proc2Dmem_command testbench.pipeline_0.ex_co_IR testbench.pipeline_0.ex_co_enable testbench.pipeline_0.mem_stall_out testbench.pipeline_0.ex_co_valid_inst testbench.pipeline_0.co_selected }
...
gui_list_set_filter -id ${Data.1} -text {co_selected}
gui_list_show_data -id ${Data.1} {testbench.pipeline_0}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {testbench.pipeline_0.co_selected }}
...
gui_open_source -id ${Source.1}  -replace -active _vcs_unit__1714782935 /afs/umich.edu/user/s/u/surajrs/470/group10w19/verilog/pipeline.v
...
gui_wv_zoom_timerange -id ${Wave.1} 2304 6914
gui_list_add_group -id ${Wave.1} -after {New Group} {Group1}
gui_list_add_group -id ${Wave.1}  -after Group1 {Group1|memory_1}
gui_list_add_group -id ${Wave.1} -after Group1|memory_1 {Group1|memory}
gui_list_expand -id ${Wave.1} testbench.pipeline_0.rob_retire_out
gui_list_select -id ${Wave.1} {testbench.pipeline_0.rob_retire_out.opcode }
...
gui_marker_move -id ${Wave.1} {C1} 3900
...
gui_wv_zoom_timerange -id ${Wave.2} 0 4610
gui_list_add_group -id ${Wave.2} -after {New Group} {memory}
gui_list_expand -id ${Wave.2} testbench.pipeline_0.ex_co_IR
gui_list_expand -id ${Wave.2} testbench.pipeline_0.ex_co_enable
gui_list_expand -id ${Wave.2} testbench.pipeline_0.co_selected
gui_list_select -id ${Wave.2} {testbench.pipeline_0.mem_stall_out }
...
gui_list_set_insertion_bar  -id ${Wave.2} -group memory  -position in

gui_marker_move -id ${Wave.2} {C1} 3900
