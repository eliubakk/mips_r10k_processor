...
# DVE full session
# Saved on Mon Apr 15 18:44:44 2019
# Designs open: 1
#   Sim: dve
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 257} {height 714} {dock_state left} {dock_on_new_line true} {child_hier_colhier 149} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 494} {height 714} {dock_state left} {dock_on_new_line true} {child_data_colvariable 212} {child_data_colvalue 153} {child_data_coltype 144} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1919} {height 167} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{1 177} {1920 1157}}
...
set _session_group_35 Group12
gui_sg_create "$_session_group_35"
set Group12 "$_session_group_35"
...
set _session_group_36 Group13
gui_sg_create "$_session_group_36"
set Group13 "$_session_group_36"
...
catch { gui_list_select -id ${Data.1} {testbench.pipeline_0.store_queue.store_data_stall testbench.pipeline_0.store_queue.data_ready_next testbench.pipeline_0.store_queue.addr_ready_next testbench.pipeline_0.store_queue.ld_pos testbench.pipeline_0.store_queue.rd_valid testbench.pipeline_0.store_queue.addr_next testbench.pipeline_0.store_queue.data_rd testbench.pipeline_0.store_queue.rd_en testbench.pipeline_0.store_queue.head_next testbench.pipeline_0.store_queue.tail_next testbench.pipeline_0.store_queue.data_next testbench.pipeline_0.store_queue.addr_rd }}
...
gui_wv_zoom_timerange -id ${Wave.1} 8615 9405
...
gui_marker_move -id ${Wave.1} {C1} 9010
gui_view_scroll -id ${Wave.1} -vertical -set 403
