...
# DVE full session
# Saved on Fri Apr 19 21:20:31 2019
# Designs open: 1
#   Sim: dve
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 256} {height 1099} {dock_state left} {dock_on_new_line true} {child_hier_colhier 149} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 493} {height 1099} {dock_state left} {dock_on_new_line true} {child_data_colvariable 212} {child_data_colvalue 153} {child_data_coltype 144} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{0 214} {2559 1554}}
...
set _session_group_25 Group5
gui_sg_create "$_session_group_25"
set Group5 "$_session_group_25"

gui_sg_addsignal -group "$_session_group_25" { testbench.pipeline_0.issue_reg testbench.pipeline_0.issue_reg_inst_opcode testbench.pipeline_0.issue_reg_inst_valid_inst testbench.pipeline_0.issue_reg_npc testbench.pipeline_0.issue_reg_tags }

set _session_group_26 Group6
gui_sg_create "$_session_group_26"
set Group6 "$_session_group_26"

gui_sg_addsignal -group "$_session_group_26" { testbench.pipeline_0.ex_co_IR testbench.pipeline_0.ex_co_NPC testbench.pipeline_0.ex_co_alu_result testbench.pipeline_0.ex_co_branch_index testbench.pipeline_0.ex_co_branch_inst testbench.pipeline_0.ex_co_branch_target testbench.pipeline_0.ex_co_dest_reg_idx testbench.pipeline_0.ex_co_done testbench.pipeline_0.ex_co_enable testbench.pipeline_0.ex_co_halt testbench.pipeline_0.ex_co_illegal testbench.pipeline_0.ex_co_rd_mem testbench.pipeline_0.ex_co_rega testbench.pipeline_0.ex_co_rega_st testbench.pipeline_0.ex_co_sq_idx testbench.pipeline_0.ex_co_take_branch testbench.pipeline_0.ex_co_valid_inst testbench.pipeline_0.ex_co_wr_mem }

set _session_group_27 Group7
gui_sg_create "$_session_group_27"
set Group7 "$_session_group_27"

gui_sg_addsignal -group "$_session_group_27" { testbench.pipeline_0.mem_co_IR testbench.pipeline_0.mem_co_NPC testbench.pipeline_0.mem_co_alu_result testbench.pipeline_0.mem_co_dest_reg_idx testbench.pipeline_0.mem_co_enable testbench.pipeline_0.mem_co_halt testbench.pipeline_0.mem_co_illegal testbench.pipeline_0.mem_co_valid_inst }

set _session_group_28 Group8
gui_sg_create "$_session_group_28"
set Group8 "$_session_group_28"

gui_sg_addsignal -group "$_session_group_28" { testbench.pipeline_0.co_ret_IR testbench.pipeline_0.co_ret_NPC testbench.pipeline_0.co_ret_branch_inst testbench.pipeline_0.co_ret_branch_prediction testbench.pipeline_0.co_ret_branch_valid testbench.pipeline_0.co_ret_dest_reg_idx testbench.pipeline_0.co_ret_enable testbench.pipeline_0.co_ret_halt testbench.pipeline_0.co_ret_illegal testbench.pipeline_0.co_ret_result testbench.pipeline_0.co_ret_take_branch testbench.pipeline_0.co_ret_valid_inst }

set _session_group_29 Group2
gui_sg_create "$_session_group_29"
set Group2 "$_session_group_29"

gui_sg_addsignal -group "$_session_group_29" { testbench.pipeline_0.ret_branch_inst testbench.pipeline_0.ret_pred_correct testbench.pipeline_0.retire_inst_busy testbench.pipeline_0.retire_is_store testbench.pipeline_0.retire_reg_NPC testbench.pipeline_0.retire_reg_phys testbench.pipeline_0.retire_reg_wr_data testbench.pipeline_0.retire_reg_wr_en testbench.pipeline_0.retire_reg_wr_idx }

set _session_group_30 Group10
gui_sg_create "$_session_group_30"
set Group10 "$_session_group_30"


set _session_group_31 Group11
gui_sg_create "$_session_group_31"
set Group11 "$_session_group_31"


set _session_group_32 regf_0
gui_sg_create "$_session_group_32"
set regf_0 "$_session_group_32"

gui_sg_addsignal -group "$_session_group_32" { testbench.pipeline_0.regf_0.phys_registers testbench.pipeline_0.regf_0.rd_idx testbench.pipeline_0.regf_0.wr_idx testbench.pipeline_0.regf_0.wr_data testbench.pipeline_0.regf_0.wr_en testbench.pipeline_0.regf_0.phys_registers_out testbench.pipeline_0.regf_0.rd_out {testbench.pipeline_0.regf_0.$unit} testbench.pipeline_0.regf_0.wr_clk }
...
set _session_group_35 PC_queue_cam
gui_sg_create "$_session_group_35"
set PC_queue_cam "$_session_group_35"
...
set _session_group_37 Group13
gui_sg_create "$_session_group_37"
set Group13 "$_session_group_37"

gui_sg_addsignal -group "$_session_group_37" { testbench.pipeline_0.store_queue.rd_en testbench.pipeline_0.store_queue.addr_rd testbench.pipeline_0.store_queue.ld_pos testbench.pipeline_0.store_queue.data_rd testbench.pipeline_0.store_queue.rd_valid testbench.pipeline_0.store_queue.store_data_stall testbench.pipeline_0.store_queue.addr_next testbench.pipeline_0.store_queue.addr_ready_next testbench.pipeline_0.store_queue.data_next testbench.pipeline_0.store_queue.data_ready_next testbench.pipeline_0.store_queue.head_next testbench.pipeline_0.store_queue.tail_next }

set _session_group_38 Group14
gui_sg_create "$_session_group_38"
set Group14 "$_session_group_38"

gui_sg_addsignal -group "$_session_group_38" { testbench.pipeline_0.mem2proc_response testbench.pipeline_0.mem2proc_data testbench.pipeline_0.mem2proc_tag testbench.pipeline_0.proc2mem_command testbench.pipeline_0.proc2mem_addr testbench.pipeline_0.proc2mem_data testbench.pipeline_0.proc2Dmem_addr testbench.pipeline_0.proc2Imem_addr testbench.pipeline_0.proc2Rmem_addr testbench.pipeline_0.proc2Rmem_data testbench.pipeline_0.proc2Dmem_command testbench.pipeline_0.proc2Imem_command testbench.pipeline_0.proc2Rmem_command testbench.pipeline_0.Dmem2proc_response testbench.pipeline_0.Imem2proc_response testbench.pipeline_0.Rmem2proc_response testbench.pipeline_0.Dmem2proc_data testbench.pipeline_0.Imem2proc_data testbench.pipeline_0.Dmem2proc_tag testbench.pipeline_0.Imem2proc_tag }
...
catch { gui_list_select -id ${Data.1} {testbench.pipeline_0.proc2Rmem_data testbench.pipeline_0.proc2mem_addr testbench.pipeline_0.Imem2proc_data testbench.pipeline_0.Imem2proc_response testbench.pipeline_0.mem2proc_data testbench.pipeline_0.Dmem2proc_response testbench.pipeline_0.mem2proc_response testbench.pipeline_0.Rmem2proc_response testbench.pipeline_0.proc2Rmem_addr testbench.pipeline_0.proc2Imem_addr testbench.pipeline_0.Dmem2proc_tag testbench.pipeline_0.proc2Imem_command testbench.pipeline_0.Imem2proc_tag testbench.pipeline_0.Dmem2proc_data testbench.pipeline_0.proc2mem_data testbench.pipeline_0.mem2proc_tag testbench.pipeline_0.proc2mem_command testbench.pipeline_0.proc2Rmem_command testbench.pipeline_0.proc2Dmem_addr testbench.pipeline_0.proc2Dmem_command }}
...
gui_wv_zoom_timerange -id ${Wave.1} 0 5410
...
gui_list_set_insertion_bar  -id ${Wave.1} -group Group14  -position in

gui_marker_move -id ${Wave.1} {C1} 5410
