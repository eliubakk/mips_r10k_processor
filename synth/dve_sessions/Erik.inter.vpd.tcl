...
# DVE full session
# Saved on Sun Apr 21 07:08:04 2019
# Designs open: 1
#   Sim: dve
...
#   Group dcache0 signal count = 13
#   Group retire_buffer signal count = 21
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 249} {height 724} {dock_state left} {dock_on_new_line true} {child_hier_colhier 149} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 486} {height 724} {dock_state left} {dock_on_new_line true} {child_data_colvariable 212} {child_data_colvalue 153} {child_data_coltype 144} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1854} {height 159} {dock_state bottom} {dock_on_new_line true}}
...
gui_set_radix -radix {decimal} -signals {Sim:testbench.pipeline_0.RS0.j}
gui_set_radix -radix {twosComplement} -signals {Sim:testbench.pipeline_0.RS0.j}
...
set _session_group_194 $_session_group_193|
append _session_group_194 FIFO
gui_sg_create "$_session_group_194"
set dcache0|FIFO "$_session_group_194"

gui_sg_addsignal -group "$_session_group_194" { testbench.pipeline_0.mem_stage_0.dcache0.fifo testbench.pipeline_0.mem_stage_0.dcache0.fifo_next testbench.pipeline_0.mem_stage_0.dcache0.fifo_tail testbench.pipeline_0.mem_stage_0.dcache0.fifo_tail_next testbench.pipeline_0.mem_stage_0.dcache0.fifo_filled testbench.pipeline_0.mem_stage_0.dcache0.fifo_filled_next testbench.pipeline_0.mem_stage_0.dcache0.fifo_busy testbench.pipeline_0.mem_stage_0.dcache0.fifo_busy_next testbench.pipeline_0.mem_stage_0.dcache0.fifo_fetch_addr testbench.pipeline_0.mem_stage_0.dcache0.fifo_fetch_addr_next testbench.pipeline_0.mem_stage_0.dcache0.fetch_stride testbench.pipeline_0.mem_stage_0.dcache0.fetch_stride_next testbench.pipeline_0.mem_stage_0.dcache0.update_fifo_lru testbench.pipeline_0.mem_stage_0.dcache0.fifo_lru testbench.pipeline_0.mem_stage_0.dcache0.fifo_lru_next testbench.pipeline_0.mem_stage_0.dcache0.next_lru_idx testbench.pipeline_0.mem_stage_0.dcache0.acc testbench.pipeline_0.mem_stage_0.dcache0.temp_lru_idx testbench.pipeline_0.mem_stage_0.dcache0.fill_fifo_idx }

gui_sg_move "$_session_group_194" -after "$_session_group_193" -pos 2 

set _session_group_195 $_session_group_193|
append _session_group_195 CAM
gui_sg_create "$_session_group_195"
set dcache0|CAM "$_session_group_195"

gui_sg_addsignal -group "$_session_group_195" { testbench.pipeline_0.mem_stage_0.dcache0.fifo_addr_table_in testbench.pipeline_0.mem_stage_0.dcache0.fifo_cam_tags testbench.pipeline_0.mem_stage_0.dcache0.fifo_cam_hits testbench.pipeline_0.mem_stage_0.dcache0.fetch_addr_cam_table_in testbench.pipeline_0.mem_stage_0.dcache0.fetch_addr_cam_tags testbench.pipeline_0.mem_stage_0.dcache0.fetch_addr_cam_hits testbench.pipeline_0.mem_stage_0.dcache0.mem_queue_cam_table_in testbench.pipeline_0.mem_stage_0.dcache0.mem_queue_cam_tags testbench.pipeline_0.mem_stage_0.dcache0.mem_queue_cam_hits }

set _session_group_196 $_session_group_193|
append _session_group_196 Encoders
gui_sg_create "$_session_group_196"
set dcache0|Encoders "$_session_group_196"

gui_sg_addsignal -group "$_session_group_196" { testbench.pipeline_0.mem_stage_0.dcache0.fifo_num_hits testbench.pipeline_0.mem_stage_0.dcache0.fifo_hit_num testbench.pipeline_0.mem_stage_0.dcache0.fifo_hit_num_valid testbench.pipeline_0.mem_stage_0.dcache0.fifo_idx_hits testbench.pipeline_0.mem_stage_0.dcache0.fifo_hit_idx testbench.pipeline_0.mem_stage_0.dcache0.fifo_hit_idx_valid testbench.pipeline_0.mem_stage_0.dcache0.fifo_sel_req testbench.pipeline_0.mem_stage_0.dcache0.fifo_sel_gnt testbench.pipeline_0.mem_stage_0.dcache0.fifo_sel_num testbench.pipeline_0.mem_stage_0.dcache0.fifo_sel_num_valid testbench.pipeline_0.mem_stage_0.dcache0.fetch_addr_hits testbench.pipeline_0.mem_stage_0.dcache0.fetch_addr_hit_num testbench.pipeline_0.mem_stage_0.dcache0.fetch_addr_hit_num_valid testbench.pipeline_0.mem_stage_0.dcache0.update_fifo_fetch_addr testbench.pipeline_0.mem_stage_0.dcache0.mem_queue_hits testbench.pipeline_0.mem_stage_0.dcache0.mem_queue_hit_num testbench.pipeline_0.mem_stage_0.dcache0.mem_queue_hit_num_valid }

gui_sg_move "$_session_group_196" -after "$_session_group_193" -pos 3 

set _session_group_197 $_session_group_193|
append _session_group_197 {Mem Queue}
gui_sg_create "$_session_group_197"
set {dcache0|Mem Queue} "$_session_group_197"

gui_sg_addsignal -group "$_session_group_197" { testbench.pipeline_0.mem_stage_0.dcache0.mem_req_queue testbench.pipeline_0.mem_stage_0.dcache0.mem_req_queue_next testbench.pipeline_0.mem_stage_0.dcache0.mem_req_queue_tail testbench.pipeline_0.mem_stage_0.dcache0.mem_req_queue_tail_next testbench.pipeline_0.mem_stage_0.dcache0.send_req_ptr testbench.pipeline_0.mem_stage_0.dcache0.send_req_ptr_next testbench.pipeline_0.mem_stage_0.dcache0.mem_waiting_ptr testbench.pipeline_0.mem_stage_0.dcache0.mem_waiting_ptr_next testbench.pipeline_0.mem_stage_0.dcache0.unanswered_miss testbench.pipeline_0.mem_stage_0.dcache0.send_request testbench.pipeline_0.mem_stage_0.dcache0.update_mem_tag testbench.pipeline_0.mem_stage_0.dcache0.mem_done testbench.pipeline_0.mem_stage_0.dcache0.add_rd_to_queue testbench.pipeline_0.mem_stage_0.dcache0.mem_rd_data }

gui_sg_move "$_session_group_197" -after "$_session_group_193" -pos 4 

set _session_group_198 $_session_group_193|
append _session_group_198 Cache
gui_sg_create "$_session_group_198"
set dcache0|Cache "$_session_group_198"

gui_sg_addsignal -group "$_session_group_198" { testbench.pipeline_0.mem_stage_0.dcache0.cache_rd_en testbench.pipeline_0.mem_stage_0.dcache0.cache_rd_idx testbench.pipeline_0.mem_stage_0.dcache0.cache_rd_tag testbench.pipeline_0.mem_stage_0.dcache0.cache_rd_data testbench.pipeline_0.mem_stage_0.dcache0.cache_rd_valid testbench.pipeline_0.mem_stage_0.dcache0.cache_rd_miss_idx testbench.pipeline_0.mem_stage_0.dcache0.cache_rd_miss_tag testbench.pipeline_0.mem_stage_0.dcache0.cache_rd_miss_valid testbench.pipeline_0.mem_stage_0.dcache0.cache_wr_en testbench.pipeline_0.mem_stage_0.dcache0.cache_wr_idx testbench.pipeline_0.mem_stage_0.dcache0.cache_wr_tag testbench.pipeline_0.mem_stage_0.dcache0.cache_wr_data testbench.pipeline_0.mem_stage_0.dcache0.cache_wr_dirty testbench.pipeline_0.mem_stage_0.dcache0.cache_wr_miss_idx testbench.pipeline_0.mem_stage_0.dcache0.cache_wr_miss_tag testbench.pipeline_0.mem_stage_0.dcache0.cache_wr_miss_valid testbench.pipeline_0.mem_stage_0.dcache0.sets_out }

gui_sg_move "$_session_group_198" -after "$_session_group_193" -pos 5 

set _session_group_199 $_session_group_193|
append _session_group_199 {Vic cache}
gui_sg_create "$_session_group_199"
set {dcache0|Vic cache} "$_session_group_199"

gui_sg_addsignal -group "$_session_group_199" { testbench.pipeline_0.mem_stage_0.dcache0.vic_rd_en testbench.pipeline_0.mem_stage_0.dcache0.vic_rd_idx testbench.pipeline_0.mem_stage_0.dcache0.vic_rd_tag testbench.pipeline_0.mem_stage_0.dcache0.vic_rd_out testbench.pipeline_0.mem_stage_0.dcache0.vic_rd_valid testbench.pipeline_0.mem_stage_0.dcache0.victim testbench.pipeline_0.mem_stage_0.dcache0.victim_valid testbench.pipeline_0.mem_stage_0.dcache0.victim_idx testbench.pipeline_0.mem_stage_0.dcache0.evicted testbench.pipeline_0.mem_stage_0.dcache0.evicted_valid }

gui_sg_move "$_session_group_199" -after "$_session_group_193" -pos 6 

set _session_group_200 $_session_group_193|
append _session_group_200 {memory signals}
gui_sg_create "$_session_group_200"
set {dcache0|memory signals} "$_session_group_200"

gui_sg_addsignal -group "$_session_group_200" { testbench.pipeline_0.mem_stage_0.dcache0.rd_en testbench.pipeline_0.mem_stage_0.dcache0.proc2Dcache_rd_addr testbench.pipeline_0.mem_stage_0.dcache0.Dcache_rd_data_out testbench.pipeline_0.mem_stage_0.dcache0.Dcache_rd_valid_out testbench.pipeline_0.mem_stage_0.dcache0.Dcache_rd_miss_addr_out testbench.pipeline_0.mem_stage_0.dcache0.Dcache_rd_miss_data_out testbench.pipeline_0.mem_stage_0.dcache0.Dcache_rd_miss_valid_out testbench.pipeline_0.mem_stage_0.dcache0.wr_en testbench.pipeline_0.mem_stage_0.dcache0.proc2Dcache_wr_addr testbench.pipeline_0.mem_stage_0.dcache0.proc2Dcache_wr_data testbench.pipeline_0.mem_stage_0.dcache0.proc2Dmem_addr testbench.pipeline_0.mem_stage_0.dcache0.proc2Dmem_data testbench.pipeline_0.mem_stage_0.dcache0.proc2Dmem_command testbench.pipeline_0.mem_stage_0.dcache0.Dmem2proc_response testbench.pipeline_0.mem_stage_0.dcache0.Dmem2proc_data testbench.pipeline_0.mem_stage_0.dcache0.Dmem2proc_tag }

gui_sg_move "$_session_group_200" -after "$_session_group_193" -pos 7 

set _session_group_201 retire_buffer
gui_sg_create "$_session_group_201"
set retire_buffer "$_session_group_201"

gui_sg_addsignal -group "$_session_group_201" { testbench.pipeline_0.mem_stage_0.rb0.send_req_ptr testbench.pipeline_0.mem_stage_0.rb0.Rmem2proc_response testbench.pipeline_0.mem_stage_0.rb0.retire_queue testbench.pipeline_0.mem_stage_0.rb0.send_request testbench.pipeline_0.mem_stage_0.rb0.clock testbench.pipeline_0.mem_stage_0.rb0.reset testbench.pipeline_0.mem_stage_0.rb0.retire_queue_next testbench.pipeline_0.mem_stage_0.rb0.request_not_accepted testbench.pipeline_0.mem_stage_0.rb0.retire_queue_tail testbench.pipeline_0.mem_stage_0.rb0.proc2Rmem_data testbench.pipeline_0.mem_stage_0.rb0.WR_PORTS testbench.pipeline_0.mem_stage_0.rb0.proc2Rmem_addr testbench.pipeline_0.mem_stage_0.rb0.full testbench.pipeline_0.mem_stage_0.rb0.evicted_valid testbench.pipeline_0.mem_stage_0.rb0.NUM_WAYS testbench.pipeline_0.mem_stage_0.rb0.proc2Rmem_command testbench.pipeline_0.mem_stage_0.rb0.retire_queue_tail_next {testbench.pipeline_0.mem_stage_0.rb0.$unit} testbench.pipeline_0.mem_stage_0.rb0.evicted testbench.pipeline_0.mem_stage_0.rb0.update_queue testbench.pipeline_0.mem_stage_0.rb0.send_req_ptr_next }
...
catch {gui_list_select -id ${Hier.1} {testbench.pipeline_0.mem_stage_0.dcache0}}
...
gui_list_show_data -id ${Data.1} {testbench.pipeline_0.mem_stage_0.dcache0}
...
gui_wv_zoom_timerange -id ${Wave.1} 18112 19307
...
gui_list_add_group -id ${Wave.1}  -after testbench.pipeline_0.mem_stage_0.dcache0.reset {dcache0|FIFO}
...
gui_list_expand -id ${Wave.1} testbench.pipeline_0.mem_stage_0.dcache0.fifo
gui_list_expand -id ${Wave.1} {testbench.pipeline_0.mem_stage_0.dcache0.fifo[0]}
gui_list_expand -id ${Wave.1} {testbench.pipeline_0.mem_stage_0.dcache0.fifo[0][3]}
gui_list_expand -id ${Wave.1} {testbench.pipeline_0.mem_stage_0.dcache0.fifo[0][2]}
gui_list_expand -id ${Wave.1} {testbench.pipeline_0.mem_stage_0.dcache0.fifo[0][1]}
gui_list_expand -id ${Wave.1} {testbench.pipeline_0.mem_stage_0.dcache0.fifo[0][0]}
gui_list_expand -id ${Wave.1} testbench.pipeline_0.mem_stage_0.dcache0.fifo_tail
gui_list_select -id ${Wave.1} {testbench.pipeline_0.mem_stage_0.dcache0.proc2Dcache_wr_data }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group {dcache0|memory signals}  -item {testbench.pipeline_0.mem_stage_0.dcache0.Dmem2proc_data[63:0]} -position below

gui_marker_move -id ${Wave.1} {C1} 18560
gui_view_scroll -id ${Wave.1} -vertical -set 607
