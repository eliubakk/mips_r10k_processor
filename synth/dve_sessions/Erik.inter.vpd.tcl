...
# DVE full session
# Saved on Sat Apr 20 03:05:11 2019
# Designs open: 1
#   Sim: dve
...
#   Group id_stage signal count = 23
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 252} {height 721} {dock_state left} {dock_on_new_line true} {child_hier_colhier 149} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 489} {height 721} {dock_state left} {dock_on_new_line true} {child_data_colvariable 212} {child_data_colvalue 153} {child_data_coltype 144} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1854} {height 162} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{419 113} {2273 1047}}
...
gui_load_child_values {testbench.pipeline_0.id_stage_0}
...
gui_set_radix -radix {decimal} -signals {Sim:testbench.pipeline_0.RS0.i}
gui_set_radix -radix {twosComplement} -signals {Sim:testbench.pipeline_0.RS0.i}
...
set _session_group_77 {pipeline mem signals}
gui_sg_create "$_session_group_77"
set {pipeline mem signals} "$_session_group_77"
...
catch { gui_list_select -id ${Data.1} {testbench.pipeline_0.mem2proc_response testbench.pipeline_0.mem2proc_data testbench.pipeline_0.mem2proc_tag testbench.pipeline_0.proc2mem_command testbench.pipeline_0.proc2mem_addr testbench.pipeline_0.proc2mem_data testbench.pipeline_0.mem_co_valid_inst testbench.pipeline_0.mem_co_NPC testbench.pipeline_0.mem_co_IR testbench.pipeline_0.mem_co_enable testbench.pipeline_0.mem_result_out testbench.pipeline_0.mem_stall_out testbench.pipeline_0.mem_rd_stall testbench.pipeline_0.mem_co_halt testbench.pipeline_0.mem_co_illegal testbench.pipeline_0.mem_co_dest_reg_idx testbench.pipeline_0.mem_co_alu_result testbench.pipeline_0.mem_co_halt_comb testbench.pipeline_0.mem_co_illegal_comb testbench.pipeline_0.mem_co_dest_reg_idx_comb testbench.pipeline_0.mem_co_alu_result_comb testbench.pipeline_0.mem_co_valid_inst_comb testbench.pipeline_0.mem_co_NPC_comb testbench.pipeline_0.mem_co_IR_comb testbench.pipeline_0.ex_co_wr_mem testbench.pipeline_0.ex_co_rd_mem testbench.pipeline_0.proc2Dmem_addr testbench.pipeline_0.proc2Imem_addr testbench.pipeline_0.proc2Rmem_addr testbench.pipeline_0.proc2Rmem_data testbench.pipeline_0.proc2Dmem_command testbench.pipeline_0.proc2Imem_command testbench.pipeline_0.proc2Rmem_command testbench.pipeline_0.Dmem2proc_response testbench.pipeline_0.Imem2proc_response testbench.pipeline_0.Rmem2proc_response testbench.pipeline_0.Dmem2proc_data testbench.pipeline_0.Imem2proc_data testbench.pipeline_0.Dmem2proc_tag testbench.pipeline_0.Imem2proc_tag testbench.pipeline_0.mem_co_stall testbench.pipeline_0.mem_co_comb testbench.pipeline_0.proc2Dmem_data testbench.pipeline_0.mem_dest_reg_idx_out testbench.pipeline_0.mem_valid_inst_out }}
gui_view_scroll -id ${Data.1} -vertical -set 2979
...
gui_open_source -id ${Source.1}  -replace -active OBQ /home/eliubakk/eecs470/projects/4/verilog/OBQ.v
...
gui_list_set_insertion_bar  -id ${Wave.1} -group icache  -position below

gui_marker_move -id ${Wave.1} {C1} 0
gui_view_scroll -id ${Wave.1} -vertical -set 38
