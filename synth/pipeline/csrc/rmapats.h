...
void  hs_0_M_34_0__simv_pipeline_daidir (UB  * pcode, vec32  * I987, U  I900);
void  hs_0_M_34_5__simv_pipeline_daidir (UB  * pcode, U  I900);
void  hs_0_M_35_0__simv_pipeline_daidir (UB  * pcode, vec32  * I987, U  I900);
void  hs_0_M_35_5__simv_pipeline_daidir (UB  * pcode, U  I900);
void  hs_0_M_36_0__simv_pipeline_daidir (UB  * pcode, scalar  val);
void  hs_0_M_36_5__simv_pipeline_daidir (UB  * pcode, UB  val);
void  hs_0_M_37_0__simv_pipeline_daidir (UB  * pcode, vec32  * I987, U  I900);
void  hs_0_M_38_0__simv_pipeline_daidir (UB  * pcode, vec32  * I987, U  I900);
void  hs_0_M_39_0__simv_pipeline_daidir (UB  * pcode, scalar  val);
...
void  hs_0_M_52_0__simv_pipeline_daidir (UB  * pcode, scalar  val);
void  hs_0_M_52_5__simv_pipeline_daidir (UB  * pcode, UB  val);
void  hs_0_M_53_0__simv_pipeline_daidir (UB  * pcode, scalar  val);
