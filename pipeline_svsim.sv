...
module pipeline_svsim (
    ...
    output logic [1:0]	proc2Rmem_command_out,	    output logic [1:0]	proc2Dmem_command_out,	    output logic [1:0]	proc2Imem_command_out,	
  ...
  pipeline pipeline( {>>{ clock }}, {>>{ reset }}, {>>{ enable }}, 
        ...
        {>>{ proc2Imem_command_out }}, {>>{ pipeline_completed_insts }}, 
