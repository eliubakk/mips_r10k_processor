...
# DVE full session
# Saved on Mon Feb 25 16:28:00 2019
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{361 213} {2259 1198}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 288} {height 726} {dock_state left} {dock_on_new_line true} {child_hier_colhier 184} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 383} {height 726} {dock_state left} {dock_on_new_line true} {child_data_colvariable 228} {child_data_colvalue 109} {child_data_coltype 53} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1898} {height 160} {dock_state bottom} {dock_on_new_line true}}
...
gui_sg_addsignal -group "$_session_group_2" { testbench.clock testbench.reset testbench.enable testbench.RS0.ps_alu.gnt testbench.RS0.ps_mult.gnt {testbench.RS0.rs_table_next[10].busy} {testbench.RS0.rs_table_next[11].busy} {testbench.RS0.rs_table_next[10]} {testbench.RS0.rs_table_next[11]} }
...
catch {gui_list_select -id ${Hier.1} {testbench.RS0.ps_mult}}
...
catch { gui_list_select -id ${Data.1} {testbench.RS0.ps_mult.gnt }}
